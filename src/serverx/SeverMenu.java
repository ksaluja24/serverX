 ...
 * @author Kp Saluja
 */
public class SeverMenu extends javax.swing.JFrame  {

    /**
     * Creates new form SeverMenu
     */
    public SeverMenu() {
        initComponents();
    }
    ...
    private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startButtonActionPerformed
       ServerX.start(); // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeverMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
